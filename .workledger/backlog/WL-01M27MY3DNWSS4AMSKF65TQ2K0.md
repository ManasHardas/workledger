---
schema_version: 1
id: WL-01M27MY3DNWSS4AMSKF65TQ2K0
title: Restart the daemon from the main build after the merge
status: done
proposed_by:
  harness: claude-code
...
---
The operator only sees the X look on real data after a restart
